...
class HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  String imgmus = "https://bladt.keep-pixel.ru/static/img/music.jpg";
  String imgispol = "https://bladt.keep-pixel.ru/static/img/music.jpg";
  ...
  Future<void> loadbgvideo(String url) async {
    if(kIsWeb){
      ...
      try {
        ...
        await Dio().download(
            "https://bladt.keep-pixel.ru/static/" + langData[0]['bgvideo'], filePath);
  ...
  Future<void> playmusamini(dynamic listok) async {
    ...
    if(devicecon){
      ...
      if(langData[0]['bgvideo'] != "0") {
        print("https://bladt.keep-pixel.ru/static/"+langData[0]['bgvideo']);
        loadbgvideo("https://bladt.keep-pixel.ru/static/" + langData[0]['bgvideo']);
      }
...
// Верхняя панель с поиском и профилем
  ...
  Future<void> getdivecs() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
     String? tr = prefs.getString("token");
      var urli = Uri.parse("https://bladt.keep-pixel.ru/devices");
  ...
  Future<void> adddevicetopull() async {
    ...
    http.Response response = await http.post(
      Uri.parse("https://bladt.keep-pixel.ru/devices"),
